...
// To add a new subject, add a new key (e.g., m3) with name, eyebrow, and units config.
  ...
  "ps": {
    ...
    "units": {
      ...
      "5": {
        ...
        "icon": "📐",
        "desc": "Fitting straight lines, second degree parabolas, exponential curves (y = a*b^x, y = a*x^b), method of least squares, normal equations",
        "weight": 15
      }
    }
  },
